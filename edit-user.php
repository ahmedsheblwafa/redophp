...
<body>
    ...
    <form action="" name="form" method="POST" style="margin-left:37%;">
            ...
            <div class="col-lg-3  "><label for="name">Room No. :</label></div>
                <div class="col-lg-3"><input type="number" placeholder="" name="RoomNo" min="0"  ></div>
            </div>
          
            <div class="row my-3">
                <div class="col-lg-3  "><label for="name">Ext :</label></div>
                <div class="col-lg-3"><input type="text" placeholder="" name="Ext"  ></div>
            </div>
            <div class="row my-3">
                <div class="col-lg-3  "><label for="name">Profile pic :</label></div>
                <div class="col-lg-3">    <input class="col-3" type="image" value="browse" name="PicName"></div>
