...
<body>
    ...
    <div class="container-fluid d-block py-4" style="text-align: center;">
        <h1 class="cursive-font" style='font-family: "Kaushan Script", cursive !important; color:#fbb448 ;'>
            <img src=logo_size.jpg> View Product Details<img src=logo_size.jpg>
        </h1>
    </div>
    ...
    <form action="" name="form" method="POST" style="margin-left:37%;">
            ...
            <div class="row my-3">
                ...
                <div class="col-lg-3"><input type="text"  name="name" value="" disabled></div>
            </div>
            <div class="row my-3">
            ...
            <div class="row my-3">
                ...
                <div class="col-lg-3"><input type="number"  name="price" min="0" stept="0.5" disabled></div>
            </div>
          
            <div class="row my-3">
                <div class="col-lg-3  "><label for="name">Product Picture :</label></div>
                <div class="col-lg-3  "><input type="image" disabled></div>
            </div>
            <div class="row my-3 mx-5 text-center d-inline-block">
                <input  type="submit" name="submit">
            </div>
            <div class="row my-3 m-5 text-center d-inline-block">
                <input type="submit" name="Edit this user" value="Edit this Product">
            </div>
