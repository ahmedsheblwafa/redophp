...
$result = mysqli_query($conn,"SELECT Pname ,Price,PPicPath FROM products");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <a href="Viewproducts.php" class="nav-item nav-link active"  style="color: #fbb448;">Products</a>
            ...
            <div class="table-wrapper">
                ...
                <table class="table table-striped table-hover">
                  ...
                  <?php while($row = mysqli_fetch_array($result)) {
                       ...
                       echo"<td><img style='width:75px' src='images/".$row['PPicPath']."'></td>";
                       echo "<td>";
                       echo"<a href=''>
                            <i class='fa fa-pencil' style='color:#fbb448;'></i>
                         <a href='#'> <i class='material-icons' style='color:red;'>&#xE5C9</i></a>" ;
                        echo"</td>";
                       echo"</tr>"; }?>
                    </tbody>
                </table> 
